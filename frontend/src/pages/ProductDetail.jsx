...
const ProductDetail = () => {
  ...
  const getProductCategory = (supplierName) => {
    ...
    return { name: 'Geral', color: 'bg-neutral-100 text-neutral-700 border-neutral-200' };
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50">
        <div className="text-center">
          ...
          <p className="text-neutral-600 mb-6">O produto que você procura não existe ou foi removido.</p>
          <Button asChild>
            <Link to="/products">
          ...
          <Card className="shadow-sm border-neutral-200">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                ...
                <div className="text-right">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-neutral-500 uppercase tracking-wide">Preço</span>
                  </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-start gap-3">
                <Info className="h-5 w-5 text-neutral-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-neutral-900 mb-2">Descrição do Produto</h3>
            ...
            <CardContent className="pt-6">
              <div className="space-y-4">
                ...
                <div className="bg-neutral-50 rounded-lg p-4">
                  <h4 className="font-medium text-neutral-900 mb-2">Contato WhatsApp</h4>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-neutral-600">ID do Produto:</span>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-neutral-600">Fornecedor ID:</span>
